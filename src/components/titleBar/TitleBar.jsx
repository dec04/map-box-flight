...
export default class TitleBar extends React.Component {
    ...
    render() {
        ...
        const svgMoon = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round"
                  d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/>
        </svg>;

        const svgSun = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round"
        ...
        return <div id="title-bar" className="draggable">
            ...
            <div id="app-control-buttons-group">
                <button onClick={this.setAlwaysOnTop} type="button" className="non-draggable">
                    {svgPaperClip}
                </button>
